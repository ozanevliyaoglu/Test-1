public class UseIF {
    public static void main(String[] args) {
        ...
        //Karar Kontrol
        //if (boolean) { //koşulun sağlandığında çalışan gövde}
        ...
        //logic
        // && , ||
        // && -> iki veya birden fazla koşulun sağlanması durumunda
        status =num1 > 9 && num1 < num2;
        // || -> iki veya birden fazla fazla koşuldan birinin sağlanması
